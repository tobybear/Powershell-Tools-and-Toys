...
$themeValue = Get-ItemProperty -Path "HKCU:\Software\Microsoft\Windows\CurrentVersion\Themes\Personalize" -Name "AppsUseLightTheme"
if ($themeValue.AppsUseLightTheme -eq 1) {
    $wpURL = "https://wallpapercave.com/wp/wp9378812.jpg"
} elseif ($themeValue.AppsUseLightTheme -eq 0) {
    $wpURL = "https://wallpapercave.com/wp/wp9378806.jpg"
} else {}
